    ...
    sections: [
      {
        ...
        content:
          "To transform Kenya into a globally competitive, prosperous nation through a bottom-up economic model that prioritizes the common citizen.",
        icon: "visibility",
      },
      {
        id: "economy",
        ...
        content:
          "Create 5 million jobs in 5 years through SME support, digital economy, and agricultural transformation.",
        icon: "trending_up",
      },
      {
        id: "education",
        ...
        content:
          "Free primary and secondary education, university funding reform, and technical training for 2 million youth.",
        icon: "school",
      },
      {
        id: "health",
        title: "Healthcare",
        content:
          "Universal Health Coverage through NHIF reforms and construction of 100 new hospitals.",
      ...
      <ManifestoHeader>
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: "18px", opacity: 0.9, marginBottom: "15px" }}>
      ...
      <ManifestoContent>
            ...
            <div style={{ flex: 1, minWidth: "250px" }}>
              ...
              >
                ...
                <span style={{ fontWeight: "800", color: "#10b981" }}>
                  {candidateData.sentiment.positive}%
                </span>
              </div>
              <div
                style={{
              ...
              >
                <div
                  style={{
                    width: `${candidateData.sentiment.positive}%`,
                    height: "100%",
                    background: "#10b981",
                  }}
                />
            ...
            <div style={{ flex: 1, minWidth: "250px" }}>
              ...
              >
                ...
                <span style={{ fontWeight: "800", color: "#6b7280" }}>
                  {candidateData.sentiment.neutral}%
                </span>
              </div>
              <div
                style={{
              ...
              >
                <div
                  style={{
                    width: `${candidateData.sentiment.neutral}%`,
                    height: "100%",
                    background: "#6b7280",
                  }}
                />
            ...
            <div style={{ flex: 1, minWidth: "250px" }}>
              ...
              >
                ...
                <span style={{ fontWeight: "800", color: "#ef4444" }}>
                  {candidateData.sentiment.negative}%
                </span>
              </div>
              <div
                style={{
              ...
              >
                <div
                  style={{
                    width: `${candidateData.sentiment.negative}%`,
                    height: "100%",
                    background: "#ef4444",
                  }}
                />
          ...
          <StatsGrid>
            <StatCard>
              <div className="stat-value">
                {candidateData.demographics.youth}%
              </div>
            ...
            <StatCard>
              <div className="stat-value">
                {candidateData.demographics.women}%
              </div>
            ...
            <StatCard>
              <div className="stat-value">
                {candidateData.demographics.rural}%
              </div>
            ...
            <StatCard>
              <div className="stat-value">
                {candidateData.demographics.urban}%
              </div>
            ...
            {candidateData.sections.map((section) => (
              <button
                ...
                style={{
                  padding: "12px 20px",
                  background:
                    activeSection === section.id ? "#197fe6" : "#f3f4f6",
        ...
        <Section>
          ...
          <StatsGrid>
            <StatCard>
              <div className="stat-value">
                {candidateData.engagement.totalReach}
              </div>
            ...
            <StatCard>
              <div className="stat-value">
                {candidateData.engagement.engagementRate}
              </div>
            ...
            <StatCard>
              <div className="stat-value">
                {candidateData.engagement.shares}
              </div>
            ...
            <StatCard>
              <div className="stat-value">
                {candidateData.engagement.comments}
              </div>
