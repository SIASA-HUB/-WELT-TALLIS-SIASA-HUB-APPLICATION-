...
import { buildImageUrl, getMediaUrl } from "../../utils/imageUtils";

// Check if message is auto-generated (Chinese/Photo/Video text)
const isAutoGeneratedMessage = (message, mediaType) => {
  if (!message) return true;
  const autoMessages = [
    "📷 Photo", "📹 Video", "💬 Support message", "Support message",
    "Photo", "Video", "📸 Photo", "🎥 Video", "照片", "视频", "支持信息"
  ];
...
// Get display message (only real user messages - NO Chinese/auto text)
...
// Styled Components - Green Theme with Larger Icons
...
const EndorsementDetailModal = ({
  ...
  useEffect(() => {
    if (!isOpen || isPaused || showComments || current?.media_type === "video") return;
  ...
  }, [isOpen, isPaused, showComments, handleNext, current]);
  ...
  return (
    <>
      ...
      >
        ...
        {/* Only show message if it's a REAL user message (not auto-generated Chinese/Photo/Video text) */}
